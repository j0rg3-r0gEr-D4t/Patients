...
<body id="main_body" >
	...
	<div id="form_container">
		...
		<form id="datosFisicosForm" class="appnitro"  method="post" action="actualizarDatosFisicos.php" onsubmit="return validateDatosFisicosForm()">
		...
		<div>
			<textarea id="piel_faneras" name="piel_faneras" class="element textarea small"> <?php echo $row3['Piel_Faneras'];?> </textarea> 
		</div> 
		</li>		<li class="section_break">
			<h3><b><u>Ojos:</u></b></h3>
			<p></p>
		...
		<span>
		<?php if ($row3['Ojos_Normal'] == 1) {?>
			<input id="ojos_normal" name="ojos_normal" class="element checkbox" type="checkbox" value="1" checked=yes/>
		<?php } else { ?>
		...
		<?php if ($row3['Ojos_Deformidades'] == 1) {?>
			<input id="ojos_deformidades" name="ojos_deformidades" class="element checkbox" type="checkbox" value="1" checked=yes />
		<?php } else { ?>
		...
		<?php if ($row3['Ojos_Contactos'] == 1) {?>
			<input id="" name="ojos_contactos" class="ojos_contactos" type="checkbox" value="1" checked=yes/>
		<?php } else { ?>
		...
		<div>
			<textarea id="ojos_otros" name="ojos_otros" class="element textarea small"><?php echo $row3['Ojos_Otros'];?></textarea> 
		</div> 
		</li>		<li class="section_break">
			<h3><b><u>O.R.L.:</u></b></h3>
			<p></p>
		...
		<span>
		<?php if ($row3['ORL_BucalNormal'] == 1) { ?>
			<input id="orl_bucalnormal" name="orl_bucalnormal" class="element checkbox" type="checkbox" value="1" checked=yes />
		<?php } else { ?>
		...
		<?php if ($row3['ORL_ProtesisDental'] == 1) {?>
			<input id="orl_protesisdental" name="orl_protesisdental" class="element checkbox" type="checkbox" value="1" checked=yes/>
		<?php } else { ?>
		...
		<?php if ($row3['ORL_Tabique'] == 1) {?>
			<input id="orl_tabique" name="orl_tabique" class="element checkbox" type="checkbox" value="1" checked=yes/>
		<?php } else { ?>
		...
		<div>
			<textarea id="orl_otros" name="orl_otros" class="element textarea small"><?php echo $row3['ORL_Otros'];?></textarea> 
		</div> 
		</li>		<li class="section_break">
		...
		<?php if ($row3['Cuello_Adenopatias'] == 1) {?>
			<input id="cuello_adenopatias" name="cuello_adenopatias" class="element checkbox" type="checkbox" value="1" checked=yes/>
		<?php } else { ?>
		...
		<?php if ($row3['Cuello_Tumor'] == 1) {?>
			<input id="cuello_tumor" name="cuello_tumor" class="element checkbox" type="checkbox" value="1" checked=yes/>
		<?php } else { ?>
		...
		<?php if ($row3['Cuello_LaringeNormal'] == 1) {?>
			<input id="cuello_laringe" name="cuello_laringe" class="element checkbox" type="checkbox" value="1" checked=yes/>
		<?php } else { ?>
		...
		<div>
			<input id="cuello_tiroides" name="cuello_tiroides" class="element text large" type="text" maxlength="255" value="<?php echo $row3['Cuello_Tiroides'];?>"/> 
		</div> 
		</li>		<li id="li_11" >
		<label class="description" for="element_11">Otros </label>
		<div>
			<textarea id="cuello_otros" name="cuello_otros" class="element textarea small"><?php echo $row3['Cuello_Otros'];?></textarea> 
		</div> 
		</li>		<li class="section_break">
			<h3><b><u>C.V.:</u></b></h3>
			<p></p>
		...
		<span>
		<?php if ($row3['CV_PulsoVenoso'] == 1) {?>
			<input id="cv_pulsovenoso" name="cv_pulsovenoso" class="element checkbox" type="checkbox" value="1" checked=yes/>
		<?php } else { ?>
		...
		<?php if ($row3['CV_LPE'] == 1) {?>
			<input id="cv_lpe" name="cv_lpe" class="element checkbox" type="checkbox" value="1" checked=yes/>
		<?php } else { ?>
		...
		<?php if ($row3['CV_1R'] == 1) {?>
			<input id="1r" name="1r" class="element radio" type="radio" value="1" checked=yes/>
		...
		<span>
		<?php if ($row3['CV_2R'] == 1) {?>
			<input id="2r" name="2r" class="element radio" type="radio" value="1" checked=yes/>
		...
		<span>
		<?php if ($row3['CV_3R'] == 1) {?>
			<input id="3r" name="3r" class="element checkbox" type="checkbox" value="1" checked=yes/>
		<?php } else { ?>
		...
		<?php if ($row3['CV_4R'] == 1) {?>
			<input id="4r" name="4r" class="element checkbox" type="checkbox" value="1" checked=yes/>
		<?php } else { ?>
			<input id="4r" name="4r" class="element checkbox" type="checkbox" value="1" />
		<?php } ?>	
		<label class="choice" for="element_56_2">4R</label>
		
		<?php if ($row3['CV_Galope'] == 1) {?>
			<input id="cv_galope" name="cv_galope" class="element checkbox" type="checkbox" value="1" checked=yes/>
		<?php } else { ?>
		...
		<?php if ($row3['CV_FrotePeric'] == 1) {?>
			<input id="cv_froteperic" name="cv_froteperic" class="element checkbox" type="checkbox" value="1" checked=yes/>
		<?php } else { ?>
		...
		<?php if ($row3['CV_Soplos'] == 1) {?>
			<input id="cv_soplos" name="cv_soplos" class="element checkbox" type="checkbox" value="1" checked=yes/>
		<?php } else { ?>
		...
		<div>
			<textarea id="cv_otros" name="cv_otros" class="element textarea small"><?php echo $row3['CV_Otros'];?></textarea> 
		</div> 
		</li>		<li class="section_break">
		...
		<div>
			...
			<input id="pulmonar_expansion" name="pulmonar_expansion" class="element text medium" type="text" maxlength="255" value="<?php echo $row3['Pulmonar_Expansion'];?>"/> 
		</div> 
		</li>		<li id="li_15" >
		<label class="description" for="element_15">MV: </label>
		<div>
			<input id="pulmonar_mv" name="pulmonar_mv" class="element text medium" type="text" maxlength="255" value="<?php echo $row3['Pulmonar_MV'];?>"/> 
		</div> 
		</li>		<li id="li_57" >
		<label class="description" for="element_57"> </label>
		<span>
		
		<?php if ($row3['Pulmonar_Sibilitantes'] == 1) {?>
			<input id="pulmonar_sibilitantes" name="pulmonar_sibilitantes" class="element checkbox" type="checkbox" value="1" checked=yes/>
		<?php } else { ?>
		...
		<?php if ($row3['Pulmonar_Roncos'] == 1) {?>
			<input id="pulmonar_roncos" name="pulmonar_roncos" class="element checkbox" type="checkbox" value="1" checked=yes/>
		<?php } else { ?>
		...
		<?php if ($row3['Pulmonar_Crepiantes'] == 1) {?>
			<input id="pulmonar_crepiantes" name="pulmonar_crepiantes" class="element checkbox" type="checkbox" value="1" checked=yes/>
		<?php } else { ?>
		...
		<?php if ($row3['Pulmonar_FrotePleural'] == 1) {?>
			<input id="pulmonar_frotepleural" name="pulmonar_frotepleural" class="element checkbox" type="checkbox" value="1" checked=yes/>
		<?php } else { ?>
		...
		<?php if ($row3['Pulmonar_VVNormal'] == 1) {?>
			<input id="pulmonar_vvnormal" name="pulmonar_vvnormal" class="element checkbox" type="checkbox" value="1" checked=yes/>
		<?php } else { ?>
		...
		<div>
			<input id="pulmonar_percusiontoraxica" name="pulmonar_percusiontoraxica" class="element text medium" type="text" maxlength="255" value="<?php echo $row3['Pulmonar_PercusionToraxica'];?>"/> 
		</div> 
		</li>		<li id="li_16" >
		<label class="description" for="element_16">Otros: </label>
		<div>
			<textarea id="pulmonar_otros" name="pulmonar_otros" class="element textarea small"><?php echo $row3['Pulmonar_Otros'];?></textarea> 
		</div> 
		</li>		<li class="section_break">
		...
		<div>
			<textarea id="abdomen" name="abdomen" class="element textarea small"><?php echo $row3['Abdomen'];?></textarea> 
		</div> 
		</li>		<li class="section_break">
		...
		<div>
			<textarea id="columna" name="columna" class="element textarea small"><?php echo $row3['Columna'];?></textarea> 
		</div> 
		</li>		<li class="section_break">
		...
		<div>
			<textarea id="extremidades" name="extremidades" class="element textarea small"><?php echo $row3['Extremidades'];?></textarea> 
		</div> 
		</li>		<li class="section_break">
		...
		<span>
		<?php if ($row3['CircPer_Normal']== 1) {?>
			<input id="circper_normal" name="circper_normal" class="element checkbox" type="checkbox" value="1" checked=yes/>
		<?php } else { ?>
		...
		<?php if ($row3['CircPer_Varices']== 1) {?>
			<input id="circper_varices" name="circper_varices" class="element checkbox" type="checkbox" value="1" checked=yes/>
		<?php } else { ?>
		...
		<div>
			<textarea id="circper_otros" name="circper_otros" class="element textarea small"><?php echo $row3['CircPer_Otros'];?></textarea> 
		</div> 
		</li>		<li class="section_break">
		...
		<div>
			<textarea id="observaciones" name="observaciones" class="element textarea small"><?php echo $row3['Observaciones'];?></textarea> 
		</div> 
		</li>		<li class="section_break">
			<h3><b><u>COMENTARIOS
<br><br>
- Antecedentes Personales:</u></b></h3>
		...
		<div>
			<textarea id="quirurgicos" name="quirurgicos" class="element textarea small"><?php echo $row3['Ant_Pers_Quirurgicos'];?></textarea> 
		</div> 
		</li>		<li id="li_35" >
		<label class="description" for="element_35">Aparato Respiratorio: </label>
		<div>
			<textarea id="respiratorio" name="respiratorio" class="element textarea small"><?php echo $row3['Ant_Pers_Respiratorio'];?></textarea> 
		</div> 
		</li>		<li id="li_34" >
		<label class="description" for="element_34">Sistema Nervioso Central: </label>
		<div>
			<textarea id="nervioso" name="nervioso" class="element textarea small"><?php echo $row3['Ant_Pers_Nervioso'];?></textarea> 
		</div> 
		</li>		<li id="li_33" >
		<label class="description" for="element_33">Al&eacute;rgicos: </label>
		<div>
			<textarea id="alergicos" name="alergicos" class="element textarea small"><?php echo $row3['Ant_Pers_Alergicos'];?></textarea> 
		</div> 
		</li>		<li id="li_32" >
		<label class="description" for="element_32">Aparato Digestivo: </label>
		<div>
			<textarea id="digestivos" name="digestivos" class="element textarea small"><?php echo $row3['Ant_Pers_Digestivos'];?></textarea> 
		</div> 
		</li>		<li id="li_31" >
		<label class="description" for="element_31">Trauma: </label>
		<div>
			<textarea id="trauma" name="trauma" class="element textarea small"><?php echo $row3['Ant_Pers_Trauma'];?></textarea> 
		</div> 
		</li>		
		<li id="li_36" >
		<label class="description" for="element_36">H&aacute;bitos Psico-Biol&oacute;gicos: <br><br>Tabaco: </label>
		<div>
			<textarea id="tabaco" name="tabaco" class="element textarea small"><?php echo $row3['Habitos_Tabaco'];?></textarea> 
		</div> 
		</li>		<li id="li_37" >
		<label class="description" for="element_37">Alcohol: </label>
		<div>
			<textarea id="alcohol" name="alcohol" class="element textarea small"><?php echo $row3['Habitos_Alcohol'];?></textarea> 
		</div> 
		</li>		<li id="li_38" >
		<label class="description" for="element_38">Caf&eacute;: </label>
		<div>
			<textarea id="cafe" name="cafe" class="element textarea small"><?php echo $row3['Habitos_Cafe'];?></textarea> 
		</div> 
		</li>		<li id="li_36" >
		<label class="description" for="element_36">Medicamentos: </label>
		<div>
			<textarea id="medicamentos" name="medicamentos" class="element textarea small"><?php echo $row3['Habitos_Medicamentos'];?></textarea> 
		</div> 
		</li>		<li id="li_37" >
		<label class="description" for="element_37">Deporte: </label>
		<div>
			<textarea id="deporte" name="deporte" class="element textarea small"><?php echo $row3['Habitos_Deporte'];?></textarea> 
		</div> 
		</li>		<li id="li_38" >
		<label class="description" for="element_38">Nutrici&oacute;n: </label>
		<div>
			<textarea id="nutricion" name="nutricion" class="element textarea small"><?php echo $row3['Habitos_Nutricion'];?></textarea> 
		</div> 
		</li>		<li class="section_break">
		...
		<div>
			<textarea id="familiares" name="familiares" class="element textarea small"><?php echo $row3['Antecedentes_Familiares'];?></textarea> 
		</div> 
		</li>		<li class="section_break">
		...
		<div>
			<textarea id="electrocardiograma" name="electrocardiograma" class="element textarea small"><?php echo $row3['Electrocardiograma'];?></textarea> 
		</div> 
		</li>		<li id="li_45" >
		<label class="description" for="element_45">Laboratorio: </label>
		<div>
			<textarea id="laboratorio" name="laboratorio" class="element textarea small"><?php echo $row3['Laboratorio'];?></textarea> 
		</div> 
		</li>		<li id="li_44" >
		<label class="description" for="element_44">Ultrasonido: </label>
		<div>
			<textarea id="ultrasonido" name="ultrasonido" class="element textarea small"><?php echo $row3['Ultrasonido'];?></textarea> 
		</div> 
		</li>		<li id="li_43" >
		<label class="description" for="element_43">Espirometr&iacute;a: </label>
		<div>
			<textarea id="espirometria" name="espirometria" class="element textarea small"><?php echo $row3['Espirometria'];?></textarea> 
		</div> 
		</li>		<li id="li_42" >
		<label class="description" for="element_42">Encuesta Psico-Social: </label>
		<div>
			<textarea id="encuesta" name="encuesta" class="element textarea small"><?php echo $row3['Encuesta'];?></textarea> 
		</div> 
		</li>		<li class="section_break">
		...
		<div>
			<textarea id="conclusiones" name="conclusiones" class="element textarea medium"><?php echo $row3['Conclusiones'];?></textarea> 
		</div>
		<li id="li_58" >
		<label class="description" for="element_54">Condici&oacute;n: </label>
<span>
		<?php if ($row3['Condicion'] == 1) {?>
			<input id="condicion" name="condicion" class="element radio" type="radio" value="1" checked=yes/>
		...
		<?php } else if ($row3['Condicion'] == 0) { ?>
			<input id="condicion" name="condicion" class="element radio" type="radio" value="1"/>
			<label class="choice" for="element_58_1">Apto</label>
			<input id="condicion" name="condicion" class="element radio" type="radio" value="0" checked=yes />
			<label class="choice" for="element_58_2">No Apto</label>
			<input id="condicion" name="condicion" class="element radio" type="radio" value="2" />
			<label class="choice" for="element_58_2">Apto con Limitaciones</label>
		<?php } else if ($row3['Condicion'] == 2) { ?>
			<input id="condicion" name="condicion" class="element radio" type="radio" value="1"/>
			<label class="choice" for="element_58_1">Apto</label>
			<input id="condicion" name="condicion" class="element radio" type="radio" value="0" />
			<label class="choice" for="element_58_2">No Apto</label>
			<input id="condicion" name="condicion" class="element radio" type="radio" value="2" checked=yes />
			<label class="choice" for="element_58_2">Apto con Limitaciones</label>
		<?php } else { ?>
			<input id="condicion" name="condicion" class="element radio" type="radio" value="1"/>
			<label class="choice" for="element_58_1">Apto</label>
		...
		<div>
			<textarea id="seguimiento" name="seguimiento" class="element textarea medium"><?php echo $row3['Seguimiento'];?></textarea> 
		</div> 
		</li>
				...
				<input id="saveForm" class="button_text" type="submit" name="submit" value="Actualizar" onClick="return confirm('Est&aacute; seguro que desea actualizar los datos f&iacute;sicos de este paciente?')"/>
		</li>
			</ul>
		</form>	
		<center>
